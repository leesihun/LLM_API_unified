...
export async function initDatabase(): Promise<SqlJsDatabase> {
  ...
  // Multi-attachment messages (keeps legacy file_url columns for compatibility)
  try { db.run("ALTER TABLE messages ADD COLUMN attachments TEXT NOT NULL DEFAULT '[]'"); } catch (_) { /* column exists */ }
